    ...
    <section class="w-3/4">
      <div v-if="selectedLoadout" class="p-6 bg-[#212121] border-2 border-[#000000] shadow-lg rounded-3xl">
        ...
        <div class="flex flex-col space-y-3">
          <button @click="editLoadout(selectedLoadout)" class="w-full py-3 bg-[#F4C356] text-black font-bold rounded-2xl hover:bg-orange-500 transition-all">Edit in Loadout Creator</button>
